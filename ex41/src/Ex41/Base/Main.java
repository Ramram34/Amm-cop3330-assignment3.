/*
 *  UCF COP3330 Fall 2021 Assignment 3 Solution 41
...
class NameSorter {
    ...
    public static void outputNames(ArrayList<String> names) throws IOException {
        ...
        FileWriter output = new FileWriter("C:\\Users\\halou\\Desktop\\Java Practice\\exercise41_output.txt");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner inputFile = new Scanner(new File("C:\\Users\\halou\\Desktop\\Java Practice\\exercise41_input.txt"));
